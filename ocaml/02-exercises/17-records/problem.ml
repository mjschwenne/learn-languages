...
let print_info
    { first_name; last_name; age = number_of_years_alive; number_of_cars } =
...
let modify_person (person : person) =
  let { first_name; last_name; age; number_of_cars } = person in
  match (first_name, number_of_cars) with
  | "Jan", _ -> { first_name = "Jan"; last_name; age = 30; number_of_cars }
  | _, _ -> { first_name; last_name; age; number_of_cars = number_of_cars + 6 }

module For_testing = struct
  let test_ex1 : person =
    { first_name = "Jan"; last_name = "Saffer"; age = 55; number_of_cars = 0 }

  let test_ex1' : person = { test_ex1 with age = 30 }

  let test_ex2 : person =
    { first_name = "Hugo"; last_name = "Heuzard"; age = 4; number_of_cars = 55 }
